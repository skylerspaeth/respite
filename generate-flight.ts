...
(async() => {
	const times: string[] = await request(`https://www.random.org/clock-times/?num=${count}&earliest=00%3A00&latest=23%3A59&interval=5&format=plain&rnd=new`, {}, (err, res, body) => {
